...
plot(dataPowerConsumption$datetime, as.numeric(as.character(dataPowerConsumption$globalActivePower)), xlab = "", ylab = "Global Active Power", type = "l")

plot(dataPowerConsumption$datetime, as.numeric(as.character(dataPowerConsumption$voltage)), xlab = "datetime", ylab = "Voltage", type = "l")
...
plot(dataPowerConsumption$datetime, as.numeric(as.character(dataPowerConsumption$globalReactivePower)), xlab = "datetime", ylab = "global_reactive_power", type = "l")
